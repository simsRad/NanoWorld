# PowerShell script to add SharePoint data source with proper environment handling
param(
    [string]$ApiId = "shared_sharepointonline",
    [string]$ConnectionId = "b3edf516ec61454fb4f1df811580c920"
)
...
Write-Host "Adding SharePoint data source..." -ForegroundColor Green
...
try {
    ...
    if ($LASTEXITCODE -eq 0) {
        Write-Host "SharePoint data source added successfully!" -ForegroundColor Green
    } else {
